								...
								<div id="owl-demo" class="owl-carousel owl-theme">
									<div class="item">
								  		<div class="testimonials-post">
								  			...
								  			<h6>Robert Imeri - <em>Mitrovicë, Kosovë</em></h6>
								  		</div>
								    </div>
								    <div class="item">
								  		<div class="testimonials-post">
								  			<span class="fa fa-quote-left"></span>
								  			<p>“ At vero eos et accusamus et iusto odio dignissimos ducimus qui molestias excepturi blanditis ”</p>
								  			<h6>Frank Luis - <em>Los Angeles, California</em></h6>
								  		</div>
								    </div>
								    <div class="item">
								  		<div class="testimonials-post">
								  			<span class="fa fa-quote-left"></span>
								  			<p>“ At vero eos et accusamus et iusto odio dignissimos ducimus qui molestias excepturi blanditis ”</p>
								  			<h6>Endrew Matheus - <em>Ljubljana, Slovenia</em></h6>
								  		</div>
								    </div>
								    <div class="item">
								  		<div class="testimonials-post">
								  			<span class="fa fa-quote-left"></span>
								  			<p>“ At vero eos et accusamus et iusto odio dignissimos ducimus qui molestias excepturi blanditis ”</p>
								  			<h6>Andrew Terstig - <em>Berlin, Germany</em></h6>
								  		</div>
								    </div>
								    <div class="item">
								  		<div class="testimonials-post">
					...
					<div class="container">
						...
						<div class="col-md-4">
							<div class="team-member">
								<img src="{{asset('files/images/01-team.jpg')}}" alt="">
						...
						<div class="col-md-4">
							<div class="team-member">
								<img src="{{asset('files/images/02-team.jpg')}}" alt="">
								<div class="team-content">
						...
						<div class="col-md-4">
							<div class="team-member">
								<img src="{{asset('files/images/03-team.jpg')}}" alt="">
								<div class="team-content">
					...
					<div class="container">
						...
						<div class="col-md-2 col-sm-4 col-xs-12">
							<div class="client-item">
								<img src="{{asset('files/images/01-client.png')}}" alt="">
							</div>
						</div>
						<div class="col-md-2 col-sm-4 col-xs-12">
							<div class="client-item">
								<img src="{{asset('files/images/02-client.png')}}" alt="">
							</div>
						</div>
						<div class="col-md-2 col-sm-4 col-xs-12">
							<div class="client-item">
								<img src="{{asset('files/images/03-client.png')}}" alt="">
							</div>
						</div>
						<div class="col-md-2 col-sm-4 col-xs-12">
							<div class="client-item">
								<img src="{{asset('files/images/04-client.png')}}" alt="">
							</div>
						</div>
						<div class="col-md-2 col-sm-4 col-xs-12">
							<div class="client-item">
								<img src="{{asset('files/images/05-client.png')}}" alt="">
							</div>
						</div>
						<div class="col-md-2 col-sm-4 col-xs-12">
							<div class="client-item">
								<img src="{{asset('files/images/06-client.png')}}" alt="">
							</div>
						</div>
					</div>
				</section>
