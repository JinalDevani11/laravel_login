						...
						<div class="row">
							<div class="row" id="portfolio-grid">
								<div class="item col-md-3 col-sm-6 col-xs-12 furniture">
							  		<figure>
			        					<img alt="1-image" src="{{asset('files/images/01-portfolio.jpg')}}">
			        					<figcaption>
							    ...
							    <div class="item col-md-3 col-sm-6 col-xs-12 wallpaper">
							  		<figure>
			        					<img alt="2-image" src="{{asset('files/images/02-portfolio.jpg')}}">
			        					<figcaption>
							    ...
							    <div class="item col-md-3 col-sm-6 col-xs-12 furniture">
							  		<figure>
			        					<img alt="3-image" src="{{asset('files/images/03-portfolio.jpg')}}">
			        					<figcaption>
							    ...
							    <div class="item col-md-3 col-sm-6 col-xs-12 wallpaper">
							  		<figure>
			        					<img alt="4-image" src="{{asset('files/images/04-portfolio.jpg')}}">
			        					<figcaption>
							    ...
							    <div class="item col-md-3 col-sm-6 col-xs-12 furniture">
							  		<figure>
			        					<img alt="5-image" src="{{asset('files/images/05-portfolio.jpg')}}">
			        					<figcaption>
							    ...
							    <div class="item col-md-3 col-sm-6 col-xs-12 nature">
							  		<figure>
			        					<img alt="6-image" src="{{asset('files/images/06-portfolio.jpg')}}">
			        					<figcaption>
							    ...
							    <div class="item col-md-3 col-sm-6 col-xs-12 branding">
							  		<figure>
			        					<img alt="7-image" src="{{asset('files/images/07-portfolio.jpg')}}">
			        					<figcaption>
							    ...
							    <div class="item col-md-3 col-sm-6 col-xs-12 branding">
							  		<figure>
			        					<img alt="8-image" src="{{asset('files/images/08-portfolio.jpg')}}">
			        					<figcaption>
							    ...
							    <div class="item col-md-3 col-sm-6 col-xs-12 nature">
							  		<figure>
			        					<img alt="9-image" src="{{asset('files/images/09-portfolio.jpg')}}">
			        					<figcaption>
			            					<h3>Street Fanny</h3>
			            					<p>Lorem ipsum dolor sit amet consete.</p>
			        					</figcaption>
							    ...
							    <div class="item col-md-3 col-sm-6 col-xs-12 wallpaper furniture">
							  		<figure>
			        					<img alt="10-image" src="{{asset('files/images/10-portfolio.jpg')}}">
			        					<figcaption>
							    ...
							    <div class="item col-md-3 col-sm-6 col-xs-12 branding nature">
							  		<figure>
			        					<img alt="11-image" src="{{asset('files/images/11-portfolio.jpg')}}">
			        					<figcaption>
			            					<h3>Park Bicycle</h3>
			            					<p>Lorem ipsum dolor sit amet consete.</p>
			        					</figcaption>
							    ...
							    <div class="item col-md-3 col-sm-6 col-xs-12 nature wallpaper">
							  		<figure>
			        					<img alt="12-image" src="{{asset('files/images/12-portfolio.jpg')}}">
			        					<figcaption>
