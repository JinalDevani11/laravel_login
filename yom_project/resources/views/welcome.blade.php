...
<div class="slider">
						...
						<div class="fullwidthbanner">
							<ul>
								<li class="first-slide" data-transition="fade" data-slotamount="10" data-masterspeed="300">
									<img src="{{asset('files/images/01-slide.jpg')}}" data-fullwidthcentering="on" alt="slide">
								...
								<li class="first-slide" data-transition="fade" data-slotamount="10" data-masterspeed="300">
									<img src="{{asset('files/images/02-slide.jpg')}}" data-fullwidthcentering="on" alt="slide">
								...
								<li class="first-slide" data-transition="fade" data-slotamount="10" data-masterspeed="300">
									<img src="{{asset('files/images/03-slide.jpg')}}" data-fullwidthcentering="on" alt="slide">
						...
						<div class="row">
							<div class="col-md-12">
								<div id="owl-portfolio" class="owl-carousel owl-theme">
									<div class="item">
								  		<figure>
				        					<img alt="portfolio" src="{{asset('files/images/01-portfolio.jpg')}}">
				        					<figcaption>
								    ...
								    <div class="item">
								  		<figure>
				        					<img alt="portfolio" src="{{asset('files/images/02-portfolio.jpg')}}">
				        					<figcaption>
								    ...
								    <div class="item">
								  		<figure>
				        					<img alt="portfolio" src="{{asset('files/images/03-portfolio.jpg')}}">
				        					<figcaption>
								    ...
								    <div class="item">
								  		<figure>
				        					<img alt="portfolio" src="{{asset('files/images/04-portfolio.jpg')}}">
				        					<figcaption>
				    				...
				    				<div class="item">
								  		<figure>
				        					<img alt="portfolio" src="{{asset('files/images/05-portfolio.jpg')}}">
				        					<figcaption>
								    ...
								    <div class="item">
								  		<figure>
				        					<img alt="portfolio" src="{{asset('files/images/06-portfolio.jpg')}}">
				        					<figcaption>
				    				...
				    				<div class="item">
								  		<figure>
				        					<img alt="portfolio" src="{{asset('files/images/07-portfolio.jpg')}}">
				        					<figcaption>
								    ...
								    <div class="item">
								  		<figure>
				        					<img alt="portfolio" src="{{asset('files/images/08-portfolio.jpg')}}">
				        					<figcaption>
				...
				<section class="blog-posts">
					<div class="container">
						...
						<div class="blog-item">
							<div class="col-md-4">
								<a href="blog-single.html"><img src="{{asset('files/images/01-blog.jpg')}}" alt=""></a>
						...
						<div class="blog-item">
							<div class="col-md-4">
								<a href="blog-single.html"><img src="{{asset('files/images/02-blog.jpg')}}" alt=""></a>
								<h3><a href="blog-single.html">Lorum Ipsum5</a></h3>
						...
						<div class="blog-item">
							<div class="col-md-4">
								<a href="blog-single.html"><img src="{{asset('files/images/03-blog.jpg')}}" alt=""></a>
								<h3><a href="blog-single.html">Lorum Ipsum5</a></h3>
